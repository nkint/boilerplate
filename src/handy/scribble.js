// TAKEN FROM https://github.com/generative-light/p5.scribble.js/tree/7ca5f40cfd92d293163ef33f10a5a19078b6cce6
...
function Segment(_x1, _y1, _x2, _y2) {
  ...
  this.compare = function (otherSegment) {
    ...
    if (grad2 === Number.MAX_VALUE) {
      ...
      if (((otherSegment.getPy1() - yi) * (yi - otherSegment.getPy2()) < -0.00001) || ((y1 - yi) * (yi - y2) < -0.000001)) {
        return Relation.SEPARATE
      }
